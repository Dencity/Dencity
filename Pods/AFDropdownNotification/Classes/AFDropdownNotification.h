...
@class AFDropdownNotification;

@protocol AFDropdownNotificationDelegate <NSObject>

-(void)dropdownNotificationTopButtonTapped:(AFDropdownNotification*)notification;
-(void)dropdownNotificationBottomButtonTapped:(AFDropdownNotification*)notification;
